...
$GLOBALS['TL_LANG']['tl_member_group']['imagePrint'] = ['Bild zum Download (Druckversion)', 'Das Anzeigebild wird, wenn vorhanden, mit einem Link zum Download versehen, wenn hier eine Druckversion eingestellt wird.'];
