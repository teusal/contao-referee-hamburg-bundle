...
$GLOBALS['TL_DCA']['tl_bsa_freigaben'] = [
    ...
    'config' => [
        ...
        'onsubmit_callback' => [['tl_bsa_freigaben', 'setSRName']],
        'ondelete_callback' => [['tl_bsa_freigaben', 'deleteFreigabe']],
        'sql' => [
            'keys' => [
                'id' => 'primary',
    ...
    'fields' => [
        ...
        'zeige_geburtsdatum' => [
            'inputType' => 'checkbox',
            'filter' => true,
            'save_callback' => [['tl_bsa_freigaben', 'switchDateOfBirth']],
            'sql' => "char(1) NOT NULL default ''",
        ],
        'zeige_strasse' => [
            'inputType' => 'checkbox',
            'filter' => true,
            'save_callback' => [['tl_bsa_freigaben', 'switchStreet']],
            'sql' => "char(1) NOT NULL default ''",
        ],
        'zeige_plz' => [
            'inputType' => 'checkbox',
            'filter' => true,
            'save_callback' => [['tl_bsa_freigaben', 'switchZipcode']],
            'sql' => "char(1) NOT NULL default ''",
        ],
        'zeige_ort' => [
            'inputType' => 'checkbox',
            'filter' => true,
            'save_callback' => [['tl_bsa_freigaben', 'switchCity']],
            'sql' => "char(1) NOT NULL default ''",
        ],
        'zeige_telefon1' => [
            'inputType' => 'checkbox',
            'filter' => true,
            'save_callback' => [['tl_bsa_freigaben', 'switchPhone1']],
            'sql' => "char(1) NOT NULL default ''",
        ],
        'zeige_telefon2' => [
            'inputType' => 'checkbox',
            'filter' => true,
            'save_callback' => [['tl_bsa_freigaben', 'switchPhone2']],
            'sql' => "char(1) NOT NULL default ''",
        ],
        'zeige_telefon_mobil' => [
            'inputType' => 'checkbox',
            'filter' => true,
            'save_callback' => [['tl_bsa_freigaben', 'switchPhoneMobile']],
            'sql' => "char(1) NOT NULL default ''",
        ],
        'zeige_fax' => [
            'inputType' => 'checkbox',
            'filter' => true,
            'save_callback' => [['tl_bsa_freigaben', 'switchFax']],
            'sql' => "char(1) NOT NULL default ''",
        ],
        'link_email' => [
            'inputType' => 'checkbox',
            'filter' => true,
            'save_callback' => [['tl_bsa_freigaben', 'switchEmail']],
            'sql' => "char(1) NOT NULL default ''",
        ],
        'zeige_foto' => [
            'inputType' => 'checkbox',
            'filter' => true,
            'save_callback' => [['tl_bsa_freigaben', 'switchPhoto']],
            'sql' => "char(1) NOT NULL default ''",
        ],
    ],
];
