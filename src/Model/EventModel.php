 ...
 * @method static EventModel|null findOneByTstamp($val, array $opt=array())
 * @method static EventModel|null findOneByEventGroup($val, array $opt=array())
 * @method static EventModel|null findOneByDate($val, array $opt=array())
 * @method static EventModel|null findOneBySeasonId($val, array $opt=array())
 * @method static EventModel|null findOneByType($val, array $opt=array())
 * @method static EventModel|null findOneByName($val, array $opt=array())
 *                                                                                                         -
