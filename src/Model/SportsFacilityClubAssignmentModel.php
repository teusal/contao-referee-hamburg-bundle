 ...
 * @method static SportsFacilityClubAssignmentModel|null findOneByTstamp($col, $val, array $opt=array())
 * @method static SportsFacilityClubAssignmentModel|null findOneByClubId($col, $val, array $opt=array())
 * @method static SportsFacilityClubAssignmentModel|null findOneBySportsFacilityIds($col, $val, array $opt=array())
 *                                                                                                                                                             -
