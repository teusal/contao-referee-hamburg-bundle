 ...
 * @method static RefereeModel|null findOneByTstamp($val, array $opt=array())
 * @method static RefereeModel|null findOneByCardNumber($val, array $opt=array())
 * @method static RefereeModel|null findOneByGender($val, array $opt=array())
 * @method static RefereeModel|null findOneByLastname($val, array $opt=array())
 * @method static RefereeModel|null findOneByFirstname($val, array $opt=array())
 * @method static RefereeModel|null findOneByNameReverse($val, array $opt=array())
 * @method static RefereeModel|null findOneByClubId($val, array $opt=array())
 * @method static RefereeModel|null findOneByStreet($val, array $opt=array())
 * @method static RefereeModel|null findOneByPostal($val, array $opt=array())
 * @method static RefereeModel|null findOneByCity($val, array $opt=array())
 * @method static RefereeModel|null findOneByPhone1($val, array $opt=array())
 * @method static RefereeModel|null findOneByPhone2($val, array $opt=array())
 * @method static RefereeModel|null findOneByMobile($val, array $opt=array())
 * @method static RefereeModel|null findOneByFax($val, array $opt=array())
 * @method static RefereeModel|null findOneByEmail($val, array $opt=array())
 * @method static RefereeModel|null findOneByEmailContactForm($val, array $opt=array())
 * @method static RefereeModel|null findOneByDateOfBirth($val, array $opt=array())
 * @method static RefereeModel|null findOneByDateOfBirthAsDate($val, array $opt=array())
 * @method static RefereeModel|null findOneByDateOfRefereeExamination($val, array $opt=array())
 * @method static RefereeModel|null findOneByDateOfRefereeExaminationAsDate($val, array $opt=array())
 * @method static RefereeModel|null findOneByState($val, array $opt=array())
 * @method static RefereeModel|null findOneByDeleted($val, array $opt=array())
 * @method static RefereeModel|null findOneByImage($val, array $opt=array())
 * @method static RefereeModel|null findOneByImagePrint($val, array $opt=array())
 * @method static RefereeModel|null findOneByImageExempted($val, array $opt=array())
 * @method static RefereeModel|null findOneBySearchable($val, array $opt=array())
 * @method static RefereeModel|null findOneByIsNew($val, array $opt=array())
 * @method static RefereeModel|null findOneByImportKey($val, array $opt=array())
 * @method static RefereeModel|null findOneByAddressbookVcards($val, array $opt=array())
 *                                                                                                                                -
