 ...
 * @method static ClubModel|null findOneByTstamp($val, array $opt=array())
 * @method static ClubModel|null findOneByName($val, array $opt=array())
 * @method static ClubModel|null findOneByNameShort($val, array $opt=array())
 * @method static ClubModel|null findOneByNumber($val, array $opt=array())
 * @method static ClubModel|null findOneByNameAddition($val, array $opt=array())
 * @method static ClubModel|null findOneByStreet($val, array $opt=array())
 * @method static ClubModel|null findOneByPostal($val, array $opt=array())
 * @method static ClubModel|null findOneByCity($val, array $opt=array())
 * @method static ClubModel|null findOneByPhone1($val, array $opt=array())
 * @method static ClubModel|null findOneByPhone2($val, array $opt=array())
 * @method static ClubModel|null findOneByFax($val, array $opt=array())
 * @method static ClubModel|null findOneByEmail($val, array $opt=array())
 * @method static ClubModel|null findOneByImage($val, array $opt=array())
 * @method static ClubModel|null findOneByHomepage1($val, array $opt=array())
 * @method static ClubModel|null findOneByHomepage2($val, array $opt=array())
 * @method static ClubModel|null findOneByPublished($val, array $opt=array())
 * @method static ClubModel|null findOneByRefereesActiveQuantity($val, array $opt=array())
 * @method static ClubModel|null findOneByRefereesPassiveQuantity($val, array $opt=array())
 *                                                                                                                   -
